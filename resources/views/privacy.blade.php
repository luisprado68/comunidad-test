                    ...
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-12 text-light">
                                <h3 class="text-light text-center">AVISO DE PRIVACIDAD</h3>
                                <p>Por medio de nuestra política de privacidad ponemos al tanto los usuarios de la pagina NEO COMMUNITY las debidas condiciones de uso en este sitio.</p>
                                <p>La utilización de este servicio gratuito, implica su aceptación completa y sin reservas a todas y cada una de las disposiciones incluidas en este Aviso Legal, por lo que si usted no está de acuerdo con cualquiera de las condiciones aquí establecidas, no deberá usar u/o acceder a este sitio.</p>
                                <p>Nos reservamos el derecho a modificar esta Declaración de Privacidad en cualquier momento. Su uso continuo de cualquier porción de este sitio tras la notificación o anuncio de tales modificaciones constituirá su aceptación de tales cambios.</p>
                             
                                <h4 class="text-light text-center">GALLETAS O COOKIES</h4>
                                ...
                                <h4 class="text-light text-center">POLITICA DE PROTECCIÓN DE DATOS PERSONALES</h4>
                                ...
                                <h4 class="text-light text-center">CONDUCTA RESPONSABLE</h4>
