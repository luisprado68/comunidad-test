    ...
    <div class="card bg-secondary">
        <div class="card-body footer text-light ">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="https://www.comunidadnc.com/referrer/lucho952000" aria-label="Recipient's username" aria-describedby="basic-addon2">
